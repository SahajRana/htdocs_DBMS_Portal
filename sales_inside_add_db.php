...
<body>
  ...
  <div class="login">
	<h1 style="margin-bottom: 4px;">New Sales ( Database ) Entry</h1>
    <form action="sales_entry_db_php.php" method="post">
	            ...
	            <table class="table" id="tblData">
	                <thead>
	                    <tr class="filters">
	                        ...
	                        <th style="width: 200px;"><input type="text" style="width: 200px;" class="form-control" placeholder="Date*" disabled></th>
	    ...
	    <div class="col-xs-12" >
	      ...
	      <div class="btn-group btn-group-horizontal" data-toggle="buttons" style="margin-bottom: 25px;">
	        ...
	        <label class="btn">
	          <input type="radio" name="radio" value='School'><span>School</span>
	        </label>
	        <label class="btn">
	          <input type="radio" name="radio" value='University'><span>University</span>
	        </label>
	        <label class="btn">
	    ...
	    <input type="text" name="corp" placeholder="Corporate Name*" required="required" />

    	<div class="col-xs-12" >	
	      <br> <p style="color: #efefef; margin-bottom: -5px; margin-top: 0px;">Contact Person*:</p>
	      <br>
	       <input type="text" name="contname" placeholder="Name*" required="required" />
	       <input type="number" name="contmobnum" placeholder="Mobile Number*" required="required" />
	       <input type="text" name="contemail" placeholder="Email*" required="required" />
	    </div>
	    <input type="text" name="clsifctn" placeholder="Classification* (i.e. a, b, c, local, multinational, etc)" required="required" />
    	<input type="text" name="corpcatg" placeholder="Corporate Catagory* (i.e.  pharmaceutical, travel agency, etc)" required="required" />
    	
    	

		<textarea type="text" name="othrinfo" placeholder="Other Details" ></textarea>
  ...
  <div  >
    ...
    <script src="js/sales_table_db.js"></script>
