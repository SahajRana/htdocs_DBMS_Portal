...
<head>
  <meta charset="UTF-8">
  <title>View Entries | Marketing Department System</title>
...
<body>
	<?php
		...
		$sqlCheck = "SELECT * FROM mrkg_entry";
		$result = mysqli_query($conn,$sqlCheck);

	?>
	
  <div class="login">	
	<h1 style="margin-bottom: 40px;">Marketing Department System</h1>
	<div class="row">
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th style="width: 60px; background:#fff;"><input type="text" class="form-control" placeholder="Address" disabled></th>
                        <th style="width: 60px; background:#fff;"><input type="text" class="form-control" placeholder="Frequency" disabled></th>
                        <th style="width: 60px; background:#fff;"><input type="text" class="form-control" placeholder="Where to travel" disabled></th>
                 	...
                 	<?php
			          while( $row = mysqli_fetch_assoc( $result ) ){
			            ...
			            "<tr>
			              ...
			              <td id=\"tddate{$row['id']}\" style=\"width: 120px;\">{$row['date']}</td>

			              <td id=\"tdname{$row['id']}\" style=\" max-width: 100px; width:150px;\">{$row['name']}</td>
			              <td id=\"tdage{$row['id']}\" style=\" max-width: 100px; width:50px;\">{$row['age']}</td>

			              <td id=\"tdcorp{$row['id']}\" style=\"width: 120px;\">{$row['corp']}</td>
			              <td id=\"tdmobno{$row['id']}\" style=\"width: 120px;\">{$row['mobno']}</td>
			              <td id=\"tdaddress{$row['id']}\" style=\"max-width: 180px;\">{$row['address']}</td>
			              <td id=\"tdfield{$row['id']}\" style=\"background:#fff; max-width: 180px;\">{$row['field']}</td> 
			              <td id=\"tdrequest{$row['id']}\" style=\"background:#fff; max-width: 180px;\">{$row['request']}</td>
	    ...
	    <div class="modal-content">
	        ...
	        <div class="modal-body">
	        	<div class="form-group">
	                <input class="form-control " name="dxdate" id="dxdate" type="date" >
	            </div>
	            <div class="form-group">
	                <input class="form-control " name="dxname" id="dxname" type="text" >
	            </div>
	            <div class="form-group">
	                <input class="form-control " name="dxage" id="dxage" type="text" >
	            </div>
	            <div class="form-group">
	                <input class="form-control " name="dxcorp" id="dxcorp" type="text" placeholder="Corporation">
	            </div>
	            <div class="form-group">
	                <input class="form-control " name="dxmobno" id="dxmobno" type="number" placeholder="MobileNo.">
	            </div>

	            <div class="form-group">
	                <textarea rows="2" name="dxaddress" id="dxaddress" class="form-control" placeholder="Address"></textarea>
	            </div>
	            <div class="form-group">
	                <textarea rows="2" name="dxfield" id="dxfield" class="form-control" placeholder="Field"></textarea>
	            </div>
	            <div class="form-group">
	                <textarea rows="2" name="dxrequest" id="dxrequest" class="form-control" placeholder="Request"></textarea>
	            </div>
	        </div>
    ...
    <form action="mrkg_inside.php" method="post">
  ...
  <div>
    ...
    <script src="js/mrkg_view_entry_js.js"></script>
</body>
</html>